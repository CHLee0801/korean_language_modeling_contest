...
true_data_0 = jsonlload("/home/ubuntu/ch.lee/momal/data/nikluge-sa-2022-dev.jsonl")
pred_data_0 = jsonlload("/home/ubuntu/ch.lee/momal/output_file/submission_v3.jsonl")

print(evaluation_f1(true_data_0, pred_data_0))
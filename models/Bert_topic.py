...
class BERT_TOPIC(pl.LightningModule):
    def __init__(self, hparams):
        super(BERT_TOPIC, self).__init__()    
        ...
        self.topic_classifier = nn.Linear(768, self.num_label)
    ...
    def on_train_epoch_end(self):
        ...
        self.train_pred = []
        self.train_gt = []
        model_saved_path = self.hparams.checkpoint_path + 'topic_epoch_' + str(self.epoch_num) + '.pt'
        param_dict = {}

...
def evaluate(args, Model_1, Model_2):
    ...
    topic_list = ['패키지/구성품', '브랜드'] # '제품 전체', '본품',
    ...
    model_1 = Model_1(args, "topic_trinary")
    ...
    model_4 = Model_1(args, "topic_binary")
    ...
    for idx in range(len(third_out)):
        ...
        if fourth_out[idx][2] == 1:
            fifth_out.append([third_out[idx][0]])
